...
public class PressureConfiguration extends Composite {
	@UiField
	...
	private static PressureConfigurationUiBinder uiBinder = GWT.create(PressureConfigurationUiBinder.class);

	interface PressureConfigurationUiBinder extends UiBinder<Widget, PressureConfiguration> {
	}

	public PressureConfiguration(SensorAction sensorAction) {
	...
	SensorAction getSensorAction() {
		...
		action.setSensorActionCode("pressure");
