...
public class DeviceMotionConfiguration extends Composite {
	@UiField
	...
	Label errorLabel;
	// @UiField
	// Button collapseButton, infoButton;

	// @UiField
	// Button timeButton, batteryButton;
	...
	private static DeviceMotionConfigurationUiBinder uiBinder = GWT.create(DeviceMotionConfigurationUiBinder.class);

	interface DeviceMotionConfigurationUiBinder extends UiBinder<Widget, DeviceMotionConfiguration> {
	}

	public DeviceMotionConfiguration(SensorAction sensorAction) {
	...
	SensorAction getSensorAction() {
		...
		action.setSensorActionCode("devicemotion");
	 ...
	 * expand(){ //timeButton.setVisible(true);
	 * //batteryButton.setVisible(true); infoButton.setVisible(true);
