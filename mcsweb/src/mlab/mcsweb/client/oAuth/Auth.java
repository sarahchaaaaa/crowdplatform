package mlab.mcsweb.client.oAuth;
...
public abstract class Auth {
  ...
  public static native void export() /*-{
    ...
    $wnd.oauth2.login = $entry(function(req, success, failure) {
      @mlab.mcsweb.client.oAuth.Auth::nativeLogin(*)(req, success, failure);
    });

    $wnd.oauth2.expiresIn = $entry(function(req) {
      return @mlab.mcsweb.client.oAuth.Auth::nativeExpiresIn(*)(req);
    });

    $wnd.oauth2.clearAllTokens = $entry(function() {
      @mlab.mcsweb.client.oAuth.Auth::nativeClearAllTokens()();
    });
  }-*/;
